package org.apache.bookkeeper.bookie.jmh_generated;
...
import org.apache.bookkeeper.bookie.jmh_generated.GroupSortBenchmark_jmhType;
import org.apache.bookkeeper.bookie.jmh_generated.GroupSortBenchmark_TestState_jmhType;
public final class GroupSortBenchmark_reverseSortedArraySort_jmhTest {
    ...
    public BenchmarkTaskResult reverseSortedArraySort_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "reverseSortedArraySort", res.getTime(), totalOps, benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
